...
export default function LandingPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="border border-border/70 hover:border-foreground/40 transition-colors duration-300 bg-card/70"
              >
      ...
      {/* Stats Section */}
      <section className="w-full py-12 md:py-24 bg-muted/30 border-y border-border/60">
        <div className="container mx-auto px-4 md:px-6">
      ...
      <section className="w-full">
        <div className="mx-auto border-y border-border/60 py-24 gradient">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            <h2 className="font-display text-3xl font-bold tracking-tighter text-primary-foreground sm:text-4xl md:text-5xl">
