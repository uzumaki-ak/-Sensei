...
import AIResumeMaker from "./ai-resume-maker";
import SavedResumes from "./saved-resumes";
...
export default function ResumeBuilder({ initialContent, resumeId, existingAtsScore, existingFeedback }) {
  ...
  useEffect(() => {
    if (saveResult && !isSaving) {
      ...
      if (saveResult.id) {
        setCurrentResumeId(saveResult.id);
      }
    }
    if (saveError) {
    ...
    <div data-color-mode="light" className="space-y-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="ai-maker" className="gap-1.5">
        ...
        <div className="p-4 sm:p-6 bg-card rounded-xl border mt-4">
        ...
        <TabsContent value="ats" className="m-0 mt-0">
          <ATSScorePanel
            resumeId={currentResumeId}
            existingScore={existingAtsScore}
            existingFeedback={existingFeedback}
          />
        </TabsContent>

        <TabsContent value="chat" className="m-0 mt-0">
          <ResumeChat resumeId={currentResumeId} />
        </TabsContent>
